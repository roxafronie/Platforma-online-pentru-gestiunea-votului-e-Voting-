...
$((function(){window.jQuery().datetimepicker&&$(".datetimepicker").datetimepicker({format:"DD-MM-YYYY HH:mm",showTodayButton:!0,icons:{time:"mdi mdi-clock",date:"mdi mdi-calendar-clock",up:"mdi mdi-chevron-up",down:"mdi mdi-chevron-down",previous:"mdi mdi-chevron-left",next:"mdi mdi-chevron-right",today:"mdi mdi-calendar-today",clear:"mdi mdi-trash-can-outline",close:"mdi mdi-close"}})}));