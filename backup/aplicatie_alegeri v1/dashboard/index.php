...
<!DOCTYPE html>
<head>
    <title>Alegeri on-line - Administrare - Autentificare</title>
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['user_name'], $_POST['user_password'])) {
                            ...
                            if (empty($_POST["user_name"]) && empty($_POST["user_password"])) {
                                ...
                                WHERE
                                    ...
                                    AND (date_expire_login='0000-00-00 00:00:00' OR (date_expire_login<>'0000-00-00 00:00:00' AND NOW() < date_expire_login))
                                LIMIT
			                        0,1
                                ";
                                ...
                                if (mysqli_num_rows($result) == 1) {
                                    ...
                                    $_SESSION["dashboard_user_id"]   = $row['user_id'];
                                    $_SESSION["dashboard_user_name"] = $username;
