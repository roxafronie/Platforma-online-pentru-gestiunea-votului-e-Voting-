            ...
            <div class="content-wrapper">
                <div class="row">
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                            ...
                            if (count($errors) > 0) {
                                ...
                                if ($result) {
                                    ...
                                    if (!$formEdit) {
                                        echo '<p class="text-success">Utilizatorul a fost adăugat cu success.</p>';
                                    } else {
                                        echo '<p class="text-success">Utilizatorul a fost modificat cu success.</p>';
                                    }
                                } else {
                                    if (!$formEdit) {
                    ...
                    function listRecords ($connection) {
                        ...
                        if (count($records) > 0) { ?>
                            <div class="resultsContainer table-responsive">
                                <table class="table table-striped table-hover tableResults">
                                    <thead>
                                    <tr>
                                    ...
                                    foreach ($records as $key => $record) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php } else { ?>
                                                    <span class="badge badge-danger">INACTIV</span></a>
                                                <?php } ?>
                                            </td>
                                            <td>
                                                <div class="dropdown">
                        ...
                        <?php } else {
                            echo '<p class="text-warning">Momentan nu există sesiuni de alegeri!</p>';
                        } ?>
                    <?php }
                    ...
                    function delete ($connection, $id) {
                        ...
                        $result = mysqli_query($connection, $sql);
                        if ($result) {
                            echo '<p class="text-success">Utilizatorul a fost şters cu success.</p>';
                        } else {
