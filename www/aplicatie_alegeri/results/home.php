...
<!DOCTYPE html>
<head>
    <title>Alegeri on-line - Rezultate - Homepage</title>
    ...
    <div class="container-fluid page-body-wrapper">
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
                ...
                <li class="nav-item"><a href="results.php" class="nav-link"><i class="menu-icon typcn typcn-bell"></i><span class="menu-title">Rezultate</span></a></li>
            </ul>
        </nav>
            ...
            <div class="content-wrapper">
                <div class="row">
                    ...
                    FROM
                        ...
                        tbl_users_admin ua
                    WHERE
                        NOW() between e.starting_date AND e.closing_date
                    ...
                    if ($countActiveElections == 0) {
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <p class="mb-0 text-info">Nu există sesiuni de alegeri active!</p>
                                </div>
                            </div>
                        </div>
                        <?php
